...
public class testPantallaCuenta extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public void testRun() {
        ...
        //Click on Iniciar Sesion en modo Test
		...
		//Verificamos que muestra el nombre, correo
		//TODO Poner el nombre y el correo del usuario prueba
		assertTrue(solo.searchText("Nombre: "));
		assertTrue(solo.searchText("Correo: "));
	}
}
