...
public class testBusquedaIngrediente extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public void testRun() {
		...
		//Wait for activity: 'com.example.coke.fooding.MainActivity'
		assertTrue("com.example.coke.fooding.MainActivity is not found!", solo.waitForActivity(com.GPS.app.fooding.MainActivity.class));
		//Click on BUSCAR
		...
		solo.clickOnView(solo.getView(com.GPS.app.fooding.R.id.angry_btn));
		//Click on Ninguno
		solo.clickOnView(solo.getView(com.GPS.app.fooding.R.id.TextoIng2));
		//Scroll to Sal
		...
		solo.clickOnView(solo.getView(com.GPS.app.fooding.R.id.angry_btn));
		//Click on Ninguno
		solo.clickOnView(solo.getView(com.GPS.app.fooding.R.id.TextoIng3));
		//Scroll to Ajo
